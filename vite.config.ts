...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    define: {
      ...
      'process.env.USE_MOCK_DATA': useMockData ? JSON.stringify(useMockData) : 'undefined',
      'process.env.RECAPTCHA_API_KEY': recaptchaKey ? JSON.stringify(recaptchaKey) : 'undefined',
    },
    build: {
      outDir: 'dist',
      assetsDir: '',
