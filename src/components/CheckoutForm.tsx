    ...
    return (
        ...
        >
            ...
            <Grid container spacing={3}>
                ...
                <Grid size={{ xs: 12 }}>
                    <TextField fullWidth label="Card Number" required placeholder="0000 0000 0000 0000" />
                </Grid>
                <Grid size={{ xs: 12, md: 6 }}>
                    <TextField fullWidth label="Expiry Date" required placeholder="MM/YY" />
                </Grid>
                <Grid size={{ xs: 12, md: 6 }}>
                    ...
                    <Paper variant="outlined" sx={{ p: 2, bgcolor: 'grey.50' }}>
                        ...
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                            <Typography variant="body2">
                                {selectedBundle === 'bundle1' ? 'Tirzepatide 10mg Bundle' : 'Semaglutide 10mg Bundle'} (Buy 2 Get 3 Free)
                            </Typography>
                        ...
                        <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                            ...
                            <Typography variant="subtitle1" fontWeight="bold">$197.00</Typography>
                        </Box>
                    </Paper>
                </Grid>
                ...
                {/* Legal Disclaimer */}
                <Grid size={{ xs: 12 }} sx={{ mt: 2 }}>
                    <Paper variant="outlined" sx={{ p: 2, borderColor: 'warning.main', bgcolor: 'warning.light', opacity: 0.1 }}>
                        ...
                        <FormControlLabel
                            ...
                            label={
                                <Typography variant="body2" color="text.secondary">
                                    I acknowledge that the products purchased from Revolve Research are strictly for <strong>laboratory research purposes only</strong> and are not for human consumption, ingestion, or clinical use. I understand that these products have not been evaluated by the FDA and are not intended to diagnose, treat, cure, or prevent any disease. I agree to handle these materials in accordance with all applicable laws and safety regulations.
                                </Typography>
                            }
                        />
                    </Box>
                ...
                <Grid size={{ xs: 12 }} sx={{ mt: 2 }}>
                    ...
                    <Box sx={{ textAlign: 'center', mt: 1 }}>
                        <Typography variant="caption" color="text.secondary">
                            <span role="img" aria-label="lock">🔒</span> SSL Secure Checkout
                        </Typography>
                    </Box>
                </Grid>
            </Grid>
